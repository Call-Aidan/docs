...
>
  <img
    src="/images/gymsales.png"
    alt="GymSales"
    style={{ width: "32px", height: "32px", borderRadius: "6px" }}
  />
  <h2 style={{ margin: 0 }}>GymSales Integration</h2>
</div>

Tools for managing leads and appointments inside GymSales.

<AccordionGroup>
  <Accordion title="Book GymSales Appointment" icon="calendar-plus">
    Book an in-person appointment at your GymSales location to give new members a tour of the facilities.
  ...
  <Accordion title="Find or Create GymSales Client" icon="user-plus">
    Locate an existing GymSales contact or create a new one before booking an appointment.
...
>
  <img
    src="/images/hapana.png"
    alt="Hapana"
    style={{ width: "32px", height: "32px", borderRadius: "6px" }}
  />
  <h2 style={{ margin: 0 }}>Hapana Integration</h2>
</div>

Tools for surfacing schedule availability from Hapana.

<AccordionGroup>
  <Accordion title="Hapana Fetch Classes" icon="calendar-days">
    Retrieve all classes and available slots running on a specific day in Hapana.
...
<Card
  ...
  icon="plus"
  href="mailto:support@callaidan.com?subject=Tool Library Request"
>
  Email us at support@callaidan.com with: - The integration name (e.g., "Acuity
